 ...
 * @author（作者）: 徐涛
 **/
public class CenterAdapter extends RecyclerView.Adapter<CenterAdapter.TopViewHolder> {

    List<Commodity> list;
    Context context;

    public CenterAdapter(List<Commodity> list, Context context) {
        this.list = list;
    ...
    public TopViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.center_list, viewGroup,false);
    ...
    class TopViewHolder extends RecyclerView.ViewHolder {
        ...
        public TopViewHolder(@NonNull View itemView) {
            super(itemView);
            iv = itemView.findViewById(R.id.center_image);
            tv1 = itemView.findViewById(R.id.center_textOne);
            tv2 = itemView.findViewById(R.id.center_textTwo);
        }
    }
}
